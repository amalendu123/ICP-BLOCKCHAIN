...
import { idlFactory } from './ccid_tracker.did.js';
export { idlFactory } from './ccid_tracker.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CCID_TRACKER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ccid_tracker.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ccid_tracker canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ccid_tracker.did.js")._SERVICE>}
 */
export const ccid_tracker = createActor(canisterId);
